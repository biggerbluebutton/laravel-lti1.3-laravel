...
class Launch {
    ...
    public function SyncUserRoles(Content $content, string $user_id, string $lti1p3_context_id) : void {
    ...
    public function syncUser(Content $content, string $platform_id) : LtiUser {
        $fields = [
    ...
    public function syncContext(Content $content, string $deployment_id) : LtiContext {
        $fields = [
